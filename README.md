...
- **Datasets**: 
  - [CheXpert Dataset](https://stanfordmlgroup.github.io/competitions/chexpert/) (For training and testing)
  - [CheXlocalize](https://stanfordmlgroup.github.io/competitions/chexpert/) (For XAI bounding box ground-truth)
- **Pre-trained Weights**:
  - [RadImageNet](https://github.com/BMEII-AI/RadImageNet)
  - *Note: Our custom trained weights can be downloaded here (Insert Link Later).*
